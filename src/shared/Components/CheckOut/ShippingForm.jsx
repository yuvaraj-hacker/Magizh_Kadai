            ...
            <form onSubmit={handlesave} className="p-2 md:p-4">
                ...
                <div className="mb-4">
                    ...
                    <select name="Address_Type" value={formdata?.Address_Type || ''} onChange={handlechange}
                        className="w-full px-3 py-2 border rounded-md outline-none focus:ring-2 focus:ring-primary dark:bg-gray-500 dark:text-white" required
                    >
                    ...
                    <div>
                        ...
                        <div className="mb-4">
                            ...
                            <input type="tel" name="Mobilenumber" value={formdata?.Mobilenumber || ''} onChange={handlechange}
                                className="w-full px-3 py-2 border rounded-md outline-none focus:ring-2 focus:ring-primary dark:bg-gray-500 dark:text-white"
                ...
                <div className="grid grid-cols-1 gap-4 mb-4 md:grid-cols-2">
                    {/* <div>
                        ...
                        <input type="text" name="Zipcode" value={formdata?.Zipcode || ''} onChange={handlechange}
                            className="w-full px-3 py-2 border rounded-md outline-none focus:ring-2 focus:ring-primary" pattern="[0-9]*" required
                        />
                    </div> */}
                     <div>
                        <div className="mb-2">
                        ...
                        {availableZipcodes.length > 1 ? (
                            ...
                            <input type="text" name="Zipcode" value={formdata?.Zipcode || ''} onChange={handlechange}
                                className="w-full px-3 py-2 border rounded-md outline-none focus:ring-2 focus:ring-primary dark:bg-gray-500 dark:text-white" pattern="[0-9]*" required
                ...
                <div>
                    <button
                        type="submit"
                        className="w-full py-2.5 px-4 rounded-md bg-primary text-white hover:bg-secondary transition-colors duration-200"
                    >
                        {loading ? (
