...
export default function Faqsection () {
    ...
    return(
        <>
            <div>
                <div className="flex items-center mb-6 bg-[#ffd646] dark:bg-gray-700 w-fit p-3 rounded-3xl">
                        ...
                        <div key={index} role="accordion">
                            ...
                            >
                                ...
                                <svg 
                                    ...
                                    className={`w-4 ml-auto fill-current shrink-0 transition-transform ${
                            ...
                            <div 
                                className={`px-6 py-4 transition-all duration-300 ease-in-out dark:bg-gray-700 ${
                                    openAccordion === index 
