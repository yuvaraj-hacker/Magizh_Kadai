...
export const getallproducts = async(params)=>{
    var res=await axios.get(`${apiurl()}/products/apigetallproducts`,{params:params});
    return res.data;
  }
...
export const apigetproductbyid = async (id ) => {
    try {
        const res = await axios.get(`${apiurl()}/products/apigetproductsbyid`, { params: { _id: id }   });
        return res.data;
    } catch (error) {
        console.error(error);
...
export  const savesearchquery = async (query,Email) => {
    try {
        const res = await axios.post(`${apiurl()}/searchquery/apisavesearchquery`, { query ,Email});
        return res.data;
    } catch (error) {
