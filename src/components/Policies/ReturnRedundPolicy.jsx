        ...
        <>
         <section>
            ...
            <div className="px-4 py-5 mx-auto my-5 md:my-10 max-w-[75rem]">
                ...
                <div className="mt-3 text-lg">At Kiranaa Bazaar, we aim to provide the best shopping experience. If you’re not satisfied with your purchase, here’s how we can help:</div>
                <div className="my-5">
                    ...
                    <p className="my-3 text-lg text-justify">
                        For any questions or assistance, please contact us at support @kiranaabazaar.com or call us at +1 916-507-4320.
                    </p>
