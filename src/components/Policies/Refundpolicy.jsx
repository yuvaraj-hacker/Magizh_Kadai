        ...
        <section>
            ...
            <div className="px-4 py-5 mx-auto my-5 md:my-10">
                ...
                <div className="my-5">
                    ...
                    <p className="my-3 text-lg text-justify">Before Shipment: You may cancel your order before it has been shipped by contacting us at support@Magizhkadai.com or calling us at +1 916-507-4320.</p>
                    ...
                    <p className="my-3 text-lg text-justify">Eligibility: Products can be returned within 7 to 10 working days from the date of purchase, excluding shipping charges. To initiate a return, please contact us at support@Magizhkadai.com with your order details.</p>
                    ...
                    <p className="my-3 text-lg text-justify">If you receive a damaged or defective item, please contact us immediately at support@Magizhkadai.com. We will arrange for a replacement or refund at no additional cost to you.</p>
