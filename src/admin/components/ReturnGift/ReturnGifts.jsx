...
import Tableheadpanel from '../../shared/components/Return/Tableheadpanel';
import Tableview from '../../shared/components/Return/Tableview';
import Tablepagination from '../../shared/others/Tablepagination';
import Addandeditform from '../../shared/components/Return/Addandeditform';
import ViewProducts from '../../shared/components/Return/ViewProducts';
...
import { getallreturns, getreturnitemsbyid } from '../../shared/services/apireturn/apireturn';
...
export default function ReturnGifts() {
    ...
    let isMounted = true;
    const getallreturn = useCallback(async () => {
        const res = await getallreturns({ first, rows, globalfilter, colfilter });
    ...
    const viewProducts = async (ReturnGift_id) => {
        console.log(ReturnGift_id)
        var res = await getreturnitemsbyid(ReturnGift_id);
