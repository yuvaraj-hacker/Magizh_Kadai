          ...
          <form onSubmit={!formdata?._id ? handlesave : handleupdate}>
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
              ...
              <div className="lg:col-span-1">
                <div className="h-full p-4 bg-gray-50 rounded-xl">
                  <label className="block mx-auto max-w-80 w-full transition-colors bg-white border-2 border-primary border-dashed cursor-pointer aspect-square rounded-xl hover:border-primary">
                    {
                      formdata?.Images ?
                ...
                <div className=" grid-cols-1 gap-6 md:grid-cols-2">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 transition-all border-0 rounded-lg outline-none bg-gray-50 focus:ring-2 focus:ring-primary"
                      required
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handlechange}
                      className="w-full px-4 py-3 transition-all border-0 rounded-lg outline-none appearance-none bg-gray-50 focus:ring-2 focus:ring-primary"
                      required
                    >
            ...
            <div className="mt-8">
              <div className="flex items-center justify-between mb-4">
                ...
                <button type="button" onClick={addSubcategory} className="inline-flex items-center gap-2 px-4 py-2 font-medium text-primary transition-colors rounded-lg bg-green-50 hover:bg-green-100"  >
            ...
            <div className="mt-8">
              <button
                type="submit"
                disabled={loading}
                className="relative w-full py-4 overflow-hidden font-medium text-white transition-all bg-primary   rounded-xl  "
              >
