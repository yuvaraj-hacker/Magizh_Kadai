...
function AddOrder(props) {
    ...
    const Stock = (rowData, rowIndex) => {
        return (
            <div>
                <InputText type="text" name="QTY" value={rowData?.QTY} readOnly onChange={(event) => handlechangeProduct(event, rowIndex)} className="w-full focus:outline-none px-4 py-2 border rounded-md outline-none" />
            </div>
        )
    }
    ...
    const Disc = (rowData, rowIndex) => {
        return (
            <div>
                <input type="number" name="Discount_Percentage" value={rowData?.Discount} onChange={(event) => handlechangeProduct(event, rowIndex)} className="w-full focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 px-4 py-2 border rounded-md outline-none" />
            </div>
        )
    }
    ...
    const Sub_Total = (rowData) => {
        return (
            <div>
                <input type="number" name="Sub_Total" readOnly value={rowData?.Sub_Total} className="w-full text-sm focus:outline-none px-4 py-2 outline-none" />
            </div>
        );
    };
