...
const Tableview = (props) => {
  ...
  return (
    <div className='  '  style={{ height: "calc(100vh - 197px)" }}>
      <DataTable   rowClassName={() => 'border-b border-b-primary'} selectionMode="single" value={tabledata} scrollable className='!text-sm' stateStorage="session" stateKey="dt-state-demo-local" >
