// AddandeditformMainCarousel.js
import React from 'react';
import apiurl from '../../../../shared/services/apiendpoint/apiendpoint';
import BannerUploadMainCarousel from './BannerUploadMainCarousel';

export default function AddandeditformMainCarousel({
    visible,
    setVisible,
    handlesave,
    loading,
                ...
                <div className="p-6">
                    <div className="flex items-center justify-between mb-6">
                        <h2 className="text-2xl font-bold">
                            {formdata?._id ? 'Edit Main Carousel Banner' : 'Add New Main Carousel Banner'}
                        </h2>
                        <button
