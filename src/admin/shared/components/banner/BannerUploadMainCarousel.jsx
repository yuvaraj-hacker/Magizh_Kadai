// BannerUploadMainCarousel.js

import React, { useState, useCallback } from 'react';
import PreviewModalMainsection from './PreviewModalMainsection';


const BannerUploadMainCarousel = ({ banners = [], onChange, apiUrl }) => {
    ...
    <div className="min-h-screen p-6 bg-gray-50">
      <div className="p-6 mb-8 bg-white shadow-sm rounded-xl">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-xl font-semibold text-gray-800">Main Carousel Banner</h3>
          <div className="text-sm text-gray-500">
            {banners.length} / 6 banners
          </div>
        </div>
...
export default BannerUploadMainCarousel;
